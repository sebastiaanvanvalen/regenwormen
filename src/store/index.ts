...
export const store = createStore({
    ...
    actions: {},
    mutations: {
        newGame: (state: GameVar): void => {
            state.gameStatus = "empty";
        ...
        loseRound: (state: GameVar): void => {
            ...
            const activeTiles = state.tiles.filter(tile => tile.active === true);
        ...
        resetMessage: (state: GameVar): void => {
            state.message = {
                type: "none",
                receiver: "none",
                message: "none",
        ...
        endGame: (state: GameVar): void => {
            state.players[state.currentPlayerIndex].winStatus = true;
            state.players.forEach(element => element.playing === false);
        }
    },
    modules: {}
});
